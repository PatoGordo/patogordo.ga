Vue.component('Skills', {
  ...
  template: `
	<div class="div-component skills">
		...
		<CardSkill imageSrc="Src/Images/node.png" alt="NodeJs" title="NodeJs" description="I started learning NodeJs about 3 months ago, I really like NodeJs because I can create secure APIs and discord bots in an easy way, I've done several projects like discord bots and APIs." exemple="https://github.com/PatoGordo/contact-me-express" />		
		<CardSkill imageSrc="Src/Images/htmlcss.png" alt="HTML & CSS" title="HTML & CSS" description="I use HTML and CSS for about 2 years, I created clone UI projects, I already cloned the UI of Netflix, Spotify, Google and others." exemple="https://github.com/PatoGordo/Spotify-web-mobile" />
